...
class OnyomiList extends StatelessWidget {
  const OnyomiList({Key? key, required this.kanji}) : super(key: key);
  final Kanji kanji;
  @override
  Widget build(BuildContext context) {
    final listOny = SplitText().extractRhythmKanji(kanji.onyomi);
    return Container(
      ...
      child: Stack(
        children: [
          ...
          CornerTitle( title: AppTextTranslate.getTranslatedText(EnumAppText.txtOnyomi) ,width: 100,)
        ],
      ),
    );
  }

...
class _DrawingRoomWidgetState extends State<DrawingRoomWidget>
          ...
          body: Stack(
            children: [
              ...
              Container(
                ...
                width: size.width,
                margin: EdgeInsets.all(20).copyWith(top: size.height * 0.15),
  ...
  _buildAnimateDraw() {
    final listStringPath =
        SplitText().extractPathDataList(widget.state.kanjiCurrent.path);
    final paint = Paint()
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                      border: Border(bottom: BorderSide(color: primaryColor))),
                  child: Icon(
                    !widget.state.isHideActionPracticeWriting

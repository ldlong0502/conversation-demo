...
class AlertDialogResult extends StatelessWidget {
  const AlertDialogResult({Key? key,required this.isWrongResult, required this.onDoAgain, required this.isShowingDialog}) : super(key: key);
  final bool isShowingDialog;
  final bool isWrongResult;
  final Function() onDoAgain;
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedPositioned(
      ...
      top: isShowingDialog ? size.height * 0.2 : -size.height * 0.5,
      left: size.width * 0.1,

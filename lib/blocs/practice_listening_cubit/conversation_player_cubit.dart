...
class ConversationPlayerCubit extends Cubit<Lesson?> {
  ...
  void play() async {
    ...
    emit(state!
        .copyWith(isPlaying: true, isLoading: false, durationMax: duration));
  ...
  void playCompleted() async {
    ...
    scrollController.scrollTo(
        index: 0, alignment: 0.1, duration: const Duration(milliseconds: 500));
  ...
  void scrollToWidget() {
    ...
    previousIndex = index;
    if (!checkItemVisible(index) && !isPaused) {
      scrollController.scrollTo(
